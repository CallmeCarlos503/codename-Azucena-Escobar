...
class Db {
  ...
  static String tabla8 =
      "CREATE TABLE DEPARTAMENTO(ID INTEGER,NOMBRE TEXT NOT NULL,ID_AREA INTEGER,COORDENADAS TEXT,PRECIOA DECIMAL(2,4),PRECIOB DECIMAL(2,4),PRECIOC DECIMAL(2,4),PRIMARY KEY(ID AUTOINCREMENT));";
  ...
  static String insert5 =
      "INSERT INTO DEPARTAMENTO(NOMBRE,ID_AREA,COORDENADAS,PRECIOA,PRECIOB,PRECIOC) VALUES ('Nejapa', 1,'13.877756, -89.173645',3.35,2.25,5.00);";
  static String insert6 =
      "INSERT INTO DEPARTAMENTO(NOMBRE,ID_AREA,COORDENADAS,PRECIOA,PRECIOB,PRECIOC) VALUES ('Apopa', 2,'13.795373, -89.177847',2.00,3.00,6.50);";
  static String insert7 =
      "INSERT INTO DEPARTAMENTO(NOMBRE,ID_AREA,COORDENADAS,PRECIOA,PRECIOB,PRECIOC) VALUES ('Ahuachapan', 2,'13.806609, -89.170987',2.00,3.00,6.50);";
  static String insert8 =
      "INSERT INTO DEPARTAMENTO(NOMBRE,ID_AREA,COORDENADAS,PRECIOA,PRECIOB,PRECIOC) VALUES ('San Salvador', 1,'13.683709, -89.236126',2.00,3.00,6.50);";
  static String insert9 =
      "INSERT INTO DEPARTAMENTO(NOMBRE,ID_AREA,COORDENADAS,PRECIOA,PRECIOB,PRECIOC) VALUES ('Apaneca', 2,'13.695855911138013, -89.21675618114723',2.00,3.00,6.50);";
